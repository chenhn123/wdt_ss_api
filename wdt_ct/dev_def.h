...
#define		FW_WDT8657		0x10   // TM1.x
#define		FW_WDT8755		0x20
#define		FW_WDT8755_ISP		(FW_WDT8755 | FW_MAYBE_ISP)
#define		FW_WDT8790		0x200
#define		FW_WDT8790_ISP		(FW_WDT8790 | FW_MAYBE_ISP)
#define		FW_WDT8760		0x800
#define		FW_WDT8760_ISP		(FW_WDT8760 | FW_MAYBE_ISP)
#define		FW_WDT8762		0x2000
#define		FW_WDT8762_ISP		(FW_WDT8762 | FW_MAYBE_ISP)
